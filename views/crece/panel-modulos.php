            ...
            <!-- <?php foreach ($progresos as $modulo): ?>
                ...
                <div class="modulo <?php echo $estaBloqueado ? 'modulo--bloqueado' : ''; ?>">
                    ...
                    <div class="modulo-footer">
                        <?php if ($estaBloqueado): ?>
                            <p class="descripcion-modulo">Este módulo se encuentra bloqueado. Completa las etapas anteriores para acceder.</p>
                        ...
                        <?php else: ?>
                            ...
                            <div class="modulo-progreso-visual">
                                ...
                                // Restamos 1 al valor de la base de datos para mostrar tareas COMPLETADAS
                                // Usamos max(0, ...) para evitar números negativos si el valor inicial fuera 0
                                $progresoActual = max(0, (int)$modulo['actividad_actual'] - 1);

                                // Nos aseguramos de no exceder los 5 círculos
                ...
                <div class="modulo <?php echo $estaBloqueado ? 'modulo--bloqueado' : ''; ?>">
                    ...
                    <div class="modulo-footer">
                        ...
                        <?php elseif ($esSeleccionable): ?>
                            <p class="descripcion-modulo">Este módulo está disponible para que lo elijas. Al seleccionarlo, pausarás temporalmente las otras opciones.</p>
