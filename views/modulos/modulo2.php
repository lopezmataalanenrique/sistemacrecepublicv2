    ...
    <section class="encabezado-modulo">
        ...
        <form method="POST" action="/guardar-actividad" id="form-intro-m2">
            ...
            <div class="m1-evaluacion-final">
                ...
                <?php
                $preguntas_intro = [
                    '201' => '¿Noto algún cambio en cómo me relaciono con mis pensamientos o emociones?',
                    '202' => '¿Noto cambios en mis respuestas o comportamientos habituales?',
                    '203' => '¿Practiqué alguno de los ejercicios y/o experimentos en mi vida diaria?'
                ];

                foreach ($preguntas_intro as $id => $texto):
                    $opciones = ($id === '203') ? ['No lo hice', 'Varias veces', 'Una vez'] : ['Sí, claramente', 'Un poco', 'Aún no lo noto'];
                ?>
