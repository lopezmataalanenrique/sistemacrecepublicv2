    ...
    <section class="encabezado-modulo">
        ...
        <form method="POST" action="/guardar-actividad" id="form-intro-m4">
            ...
            <div class="m1-evaluacion-final">
                ...
                <?php
                $preguntas_intro = [
                    '401' => '¿Noto algún cambio en cómo me relaciono con mis pensamientos o emociones?',
                    '402' => '¿Noto cambios en mis respuestas o comportamientos habituales?',
                    '403' => '¿Practiqué alguno de los ejercicios y/o experimentos en mi vida diaria?'
                ];
                ...
                <div class="m4a4-sintomas-cuerpo">
                    ...
                    ?>
                        ...
                        <input type="text" name="<?php echo $txt_id; ?>" id="txt-<?php echo $txt_id; ?>"
                            class="act4-sintoma-txt" placeholder="<?php echo $sintoma['placeholder']; ?>"
