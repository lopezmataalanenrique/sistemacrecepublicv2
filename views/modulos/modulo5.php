    ...
    <section class="encabezado-modulo">
        ...
        <form method="POST" action="/guardar-actividad" id="form-intro-m5">
            ...
            <div class="m1-evaluacion-final" style="background: #eef2f7; padding: 4rem; border-radius: 1.5rem; border: 0.2rem dashed #12307D; margin: 4rem 0;">
                ...
                <?php
                $preguntas_intro = [
                    '501' => '¿Noto algún cambio en cómo me relaciono con mis pensamientos o emociones?',
                    '502' => '¿Noto cambios en mis respuestas o comportamientos habituales?',
                    '503' => '¿Practiqué alguno de los ejercicios y/o experimentos en mi vida diaria?'
                ];

                foreach ($preguntas_intro as $id => $texto):
                    $opciones = ($id === '503') ? ['No lo hice', 'Varias veces', 'Una vez'] : ['Sí, claramente', 'Un poco', 'Aún no lo noto'];
                ?>
